...
<p>Один критерий, который мне помог — идея из этики Канта: <em>в этой задаче человек — цель или средство?</em> Если средство — делегируем. Если сам цель — оставляем.</p>
...
<p>Если меня прямо сейчас спросить — я <strong>скорее склоняюсь к B</strong>, честной машине-помощнику без имитации эмпатии. Почему: <em>обман не масштабируется как этика</em>. Но я признаю — это выбор между плохим и очень плохим, и я не уверен, что это окончательный ответ.</p>
<p>И это <strong>философия, а не инженерия</strong>. Это вопрос нашего поколения.</p>`,

    11: `<p>Это три мыслителя, которых я изучал при подготовке — не моя «армия», а точки зрения, которые помогли мне думать.</p>
...
<p><strong>Пико делла Мирандола</strong>, о котором мы говорили на пятой лекции — человек это <em>незавершённое</em> существо, которое само себя создаёт через выбор. Ядро ренессансного гуманизма.</p>
<p><strong>Ханна Арендт</strong> — различает <em>labor</em>, <em>work</em>, <em>action</em>. Только в action мы люди.</p>`,
...
<p>Я не скрываю эти слабые места. Я хочу, чтобы вы услышали позицию человека, который знает, где её можно пробить.</p>`,
    ...
    13: `<p>Итак, <strong>к чему я пока склоняюсь</strong> — после полугода работы в этой области.</p>
<p>Сразу оговорюсь: полгода — это мало. Поле меняется каждые несколько месяцев, и моя позиция тоже может <em>измениться — возможно, сильно</em>. Это не окончательный ответ, это то, что я думаю сейчас.</p>
<p>Замени руку — оставь лицо. Замени плечо — оставь улыбку. Гуманоидная форма — <em>функционально, не эмоционально</em>.</p>
<p>Почему? Функционально — форма помогает роботу работать в среде, построенной для людей: двери, лестницы, инструменты. Но <strong>эмоциональная имитация обманывает</strong> человека.</p>
<p>Uncanny Valley — не стена, которую нужно пробить. Это <em>линия, которая нас защищает</em>.</p>
<p>Это <strong>инженерное ограничение</strong>, а не окончательная моральная позиция. Я пока склоняюсь к тому, чтобы <em>не имитировать человека там, где это ведёт к когнитивному обману</em>. Возможно, через год я буду думать иначе.</p>`,
